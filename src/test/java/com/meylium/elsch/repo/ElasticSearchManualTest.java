...
public class ElasticSearchManualTest {
    ...
    public void setUp() throws UnknownHostException {
        String elasticsearch_uri = Utils.fetchProperties().getProperty("elasticsearch.uri");
        Product Product1 = new Product("id-01", "First", 402.0, 10, "c1", "desc", "");
        Product Product2 = new Product("id-02", "Second", 402.0, 10, "c1", "desc", "");
        listOfProducts.add(Product1);
        listOfProducts.add(Product2);

        ClientConfiguration clientConfiguration = ClientConfiguration.builder()
                .connectedTo(elasticsearch_uri)
                .build();
    ...
    public void givenJsonString_whenJavaObject_thenIndexDocument() throws Exception {
        String jsonObject = "{\"name\":20,\"dateOfBirth\":1471466076564,\"fullName\":\"John Doe\"}";
    ...
    public void givenSearchRequest_whenMatchAll_thenReturnAllResults() throws Exception {
        ...
        SearchHit[] searchHits = response.getHits()
                .getHits();
        List<Product> results = Arrays.stream(searchHits)
    ...
    public void givenSearchParameters_thenReturnResults() throws Exception {
        ...
        final List<Product> results = Stream.of(response.getHits()
                        .getHits(),
                response2.getHits()
                        .getHits(),
                response3.getHits()
